...
public class HorizontalScaleView extends View {
    ...
    private final int SCALE_WIDTH_SMALL = 0;//小刻度线宽度
...
//            borderLeft = 0 - scaleSpaceUnit * 1;
//            borderRight = width + scaleSpaceUnit * 1;
...
//        canvas.drawLine(minX + SCALE_WIDTH_BIG / 2, ruleHeight + LINE_WIDTH / 2, minX + (max - min) * scaleSpaceUnit - SCALE_WIDTH_BIG / 2, ruleHeight + LINE_WIDTH / 2, paint);
        ...
        float liny = ruleHeight + LINE_WIDTH / 2;

        canvas.drawLine(0,liny,width ,liny,paint);

        //画指针线
//        paint.setColor(getResources().getColor(R.color.colorPrimaryDark));
//        canvas.drawLine(width / 2, ruleHeight /2, width / 2, ruleHeight, paint);
